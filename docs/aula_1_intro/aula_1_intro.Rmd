...
### Dia 1: Introdução, R básico e data frames.
### Dia 2: Mais data frames e qualR.
### Dia 3: Openair.
### Dia 4: Mais openair e estudo de casos.
...
- Uma linguagen popular em [**data science**](https://www.datacamp.com/blog/top-programming-languages-for-data-scientists-in-2022).
...
Muitos erros podem ser causados porque: 

- R é _case-sensitive_:\ `uma_variavel` $\neq$ `Uma_variavel`.
- Faltou fechar os `( )` 
- Esqueceram de colocar uma `,`

\alert{Atentos} ao seguir os exemplos.

(Mas tudo bem, os erros são grandes professores :) )

## Antes de começar

Por favor,  \alert{façam perguntas}
```{r, echo=FALSE, fig.align='center', fig.cap="Questions. Fonte: https://xkcd.com/1256/", out.height="68%"}
include_graphics("figures/questions_2x.png")
```
...
- É importante aprender os _keyboard shortcuts_.
   ...
   - `Alt + - ` : `<-`
   - `Ctrl + d` : Apaga linha.
   - `TAB`: \alert{Autocompleta} nome de funções e diretórios de arquivos.
...
- Vamos ler dados do ano 2024 do aeroporto de Guarulhos.
...
- Baixe os dados do aeroporto de campo de marte para o ano 2024 (SBMT).
